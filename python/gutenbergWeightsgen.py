...
for iter in range(0, 999):
    ...
    #
    print('\nusing sample: ')
    h_keras.displayGenerate(model, seglen, m_index_char, m_char_index, seed, 300, h_keras.sample, temperature=1)
    print('\nusing highest prob: ')
...
# nohup python3 gutenbergWeightsgen.py > out9layer.log 2>&1 &
